...
public class NotaDebitoElectronica {
   ...
   *
   * @return possible object is {@link NotaDebitoElectronica.DetalleServicio }
   */
   ...
   *
   * @param value allowed object is {@link NotaDebitoElectronica.DetalleServicio }
   */
   ...
   *
   * @return possible object is {@link NotaDebitoElectronica.ResumenFactura }
   */
   ...
   *
   * @param value allowed object is {@link NotaDebitoElectronica.ResumenFactura }
   */
   ...
   * NotaDebitoElectronica.InformacionReferencia }
   */
   ...
   *
   * @return possible object is {@link NotaDebitoElectronica.Otros }
   */
   ...
   *
   * @param value allowed object is {@link NotaDebitoElectronica.Otros }
   */
  ...
  public static class DetalleServicio {
     ...
     *
     * <p>Objects of the following type(s) are allowed in the list {@link
     * NotaDebitoElectronica.DetalleServicio.LineaDetalle }
     */
  ...
  public static class Otros {
     ...
     *
     * <p>Objects of the following type(s) are allowed in the list {@link
     * NotaDebitoElectronica.Otros.OtroTexto }
     */
     ...
     *
     * <p>Objects of the following type(s) are allowed in the list {@link
     * NotaDebitoElectronica.Otros.OtroContenido }
     */
