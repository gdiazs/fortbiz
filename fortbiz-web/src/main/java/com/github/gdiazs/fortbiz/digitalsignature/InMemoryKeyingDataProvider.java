...
public class InMemoryKeyingDataProvider extends KeyStoreKeyingDataProvider {

  public InMemoryKeyingDataProvider(
      KeyStore keyStore,
    ...
    super(
        protectionParameter -> KeyStore.Builder.newInstance(keyStore, protectionParameter),
        certificateSelector,
  ...
  protected KeyStore.ProtectionParameter getKeyProtection(
    ...
    return new KeyStore.PasswordProtection(
        entryPasswordProvider.getPassword(entryAlias, entryCert));
  }
}
