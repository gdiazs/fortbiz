...
public class NotaCreditoElectronica {
   ...
   *
   * @return possible object is {@link NotaCreditoElectronica.DetalleServicio }
   */
   ...
   *
   * @param value allowed object is {@link NotaCreditoElectronica.DetalleServicio }
   */
   ...
   *
   * @return possible object is {@link NotaCreditoElectronica.ResumenFactura }
   */
   ...
   *
   * @param value allowed object is {@link NotaCreditoElectronica.ResumenFactura }
   */
   ...
   *
   * @return possible object is {@link NotaCreditoElectronica.Otros }
   */
   ...
   *
   * @param value allowed object is {@link NotaCreditoElectronica.Otros }
   */
  ...
  public static class DetalleServicio {
     ...
     *
     * <p>Objects of the following type(s) are allowed in the list {@link
     * NotaCreditoElectronica.DetalleServicio.LineaDetalle }
     */
  ...
  public static class Otros {
     ...
     *
     * <p>Objects of the following type(s) are allowed in the list {@link
     * NotaCreditoElectronica.Otros.OtroTexto }
     */
     ...
     *
     * <p>Objects of the following type(s) are allowed in the list {@link
     * NotaCreditoElectronica.Otros.OtroContenido }
     */
